...
This term the topic of Visual Analytics Project will be based on either [VAST Challenge 2025](https://vast-challenge.github.io/2025/index.html). There are three Mini Challenges (MC). Teams are required to choose **one** of the MC and build a Shiny Application to answer the questions of the challenge.
...
-   Uploading project poster on eLearn by ~~**26th June**~~ **2nd July 2025 (Wednesday) at 11:59pm (mid-night)**.
-   Poster presentation: ~~**2nd**~~ **5th July 2025 (Saturday), 2:00pm-3:30pm**
-   Submission of Shiny application repository, project website repository, project poster, Minutes of Meeting and Peer Evaluation: **6th July 2025 (Sunday) by 11:59pm (mid-night)**
