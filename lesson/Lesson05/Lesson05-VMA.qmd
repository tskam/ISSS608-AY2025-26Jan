...
::::: columns
::: {.column width="50%"}
-   [ggtern](https://cran.r-project.org/web/packages/ggtern/index.html) is a package that extends the functionality of ggplot2, giving the capability to plot ternary diagrams for (subset of) the ggplot2 proto geometries.
...
- Space-constrained Visualisation of Hierarchies
...
- Treemaps was first introduced by Prof. [Ben Shneiderman](https://en.wikipedia.org/wiki/Ben_Shneiderman) in 1998.
- It was used to visualise files usage in a harddisk.
- Refer to [this website](http://www.cs.umd.edu/hcil/treemap-history/) to learn more about the history of treemaps. 
...
Visit this [site](https://eagereyes.org/blog/2008/treemaps#treemaps) to learn more.


---

### Treemap Layout: Squarified Treemaps

- Optimise the placement of nodes within a level to make them as square as possible.

![](img/image5-25.jpg)

[Source](https://vanwijk.win.tue.nl/stm.pdf)
...
### Treemaps Design Best Practices 1: Hierarchy
...
### Treemaps Design Best Practices 2: Measures
...
### Treemaps Design Best Practices 3: Colour scheme
...
### Treemaps Design Best Practices 4: Labelling
...
### Treemaps Design Best Practices 5: Tooltip
